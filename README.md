...
<div align="center">
<h2>Connectors Repo for memphis broker</h2>
</div>
This repository is for memphis community to upload ready-to-use producers and consumers<br>
of different types to be reused by others :)

## ⭐️ For Example
- **REST API** - A producer program that receives data via REST and produce it to a memphis cluster
- **Slack** - A consumer program that consume message from memphis and push it towrds a slack channel
and more to come.

## 😇 How to add a new one?
It's simple!
1. Fork the repo
2. Add a new dir with the name of the connector <X-producer/consumer>
3. Add your producer/consumer code to that dir
4. Create a PR
5. A maintainer will review and merge
6. You made a huge contribution and you will receive an awesome swagpack!

## 🤔 Questions?
Join our [slack](https://join.slack.com/t/memphiscommunity/shared_invite/zt-1bdp9ydfk-QpwYIOTz4nkvTGtEL6kJYQ) :)
